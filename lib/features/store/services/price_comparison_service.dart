  ...
  void _initializeStores() {
    ...
    _stores = [
      Store(
        ...
        imageUrl: ImageConstants.othaim,
        rating: 4.2,
        isActive: true,
      ...
      Store(
        ...
        workingHours: ['8:00 AM - 12:00 AM'],
        imageUrl: ImageConstants.carrefour,
        rating: 4.1,
        isActive: true,
        createdAt: DateTime.now(),
        updatedAt: DateTime.now(),
      ...
      Store(
        ...
        workingHours: ['8:00 AM - 12:00 AM'],
        imageUrl: ImageConstants.danube,
        rating: 4.0,
        isActive: true,
        createdAt: DateTime.now(),
        updatedAt: DateTime.now(),
